...
var classBase = React.createClass({
  ...
  _addDocClickListener:function () {
    document.addEventListener('click', this._handleDocClick);
  },
  _removeDocClickListener:function () {
  ...
  render:function () {
    ...
    return (
      React.createElement("div", {
        ...
        this.state.open ?
          React.createElement("div", {className: this.props.listClassName, style: this.props.optionListStyle}, 
        ...
        React.createElement("span", {"aria-hidden": true, style: hiddenListStyle, tabIndex: -1}, 
